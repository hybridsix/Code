...
public:
	...
	virtual void GetConfiguration(SFlowNodeConfig& config)
	{
		static const SInputPortConfig inputs[] =
		{
			...
			InputPortConfig<string>( "VRPN_SERVER", _HELP("VRPN_SERVER" ), _HELP("VRPN_SERVER"), _UICONFIG("enum_int:Server0=0,Server1=1,Server2=2,Server3=3,Server4=4,Server5=5,Server6=6,Server7=7,Server8=8,Server9=9")),
			InputPortConfig<string>( "TRACKER_NAME", _HELP("TRACKER_NAME" ), _HELP("TRACKER_NAME"), _UICONFIG("enum_int:Tracker0=0,Tracker1=1,Tracker2=2,Tracker3=3,Tracker4=4,Tracker5=5,Tracker6=6,Tracker7=7,Tracker8=8,Tracker9=9")),
			{0},
		};
		...
		config.sDescription = _HELP("Retrieve values from trackers through VRPN");
		...
		case eFE_Initialize:
			{
				...
				vrpnAnalog = new vrpn_Tracker_Remote(); //vrpn_Tracker_Remote (const char * name, vrpn_Connection *c = NULL);
				vrpnAnalog->register_change_handler(NULL, handle_tracker_generic);
