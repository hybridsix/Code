...
public:
	...
	unused_marker() {}
	unused_marker& operator,(float &x) { *alias_cast<int*>(&x)=0xFFBFFFFF; return *this; }
	unused_marker& operator,(double &x) { (alias_cast<int*>(&x))[eLittleEndian?1:0]=0xFFF7FFFF; return *this; }
...
struct pe_params_area : pe_params {
	...
	pe_params_area() { type=type_id; MARK_UNUSED gravity,bUniform,damping,falloff0,bUseCallback,pGeom; }
