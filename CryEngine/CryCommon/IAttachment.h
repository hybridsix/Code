...
UNIQUE_IFACE struct IAttachmentManager
{
	...
	virtual IAttachment* CreateAttachment( const char* szName, uint32 type, const char* szBoneName=0,bool bCallProject=true) =0;
	...
	virtual IAttachmentSkin* GetIAttachmentSkinByIndex( uint32 c) const =0;
	virtual IAttachmentSkin* GetIAttachmentSkinByName(  const char* szName ) const =0; 
...
struct IAttachment
{
	...
	virtual uint32 ReName( const char* szBoneName, uint32 crc ) =0;   

	virtual uint32 GetType() const =0; 
	virtual uint32 SetBoneName(const char* szBoneName=0)=0;
	...
	virtual void AlignBoneAttachment()=0;
